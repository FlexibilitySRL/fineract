...
public class DeleteClientAddressCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public DeleteClientAddressCommandHandler(final AddressWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
         ...
         */
        return this.writePlatformService.deleteClientAddress(command.getClientId(), command.entityId(), command.commandId());
